      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" href="#attractions">Fasilitas</a></li>
    ...
    <section id="attractions" class="bg-light">
      <div class="container">
        <div class="text-center mb-5">
          ...
          <p class="section-subtitle">Fasilitas dan alat pendukung</p>
        </div>
        <div class="owl-carousel attractions-carousel">
          ...
          <img src="{{ asset('assets/img/ban.jpg') }}" alt="River Tubing" class="rounded-3 mb-3">
            <h6>Alat Pendukung</h6>
            <p class="small text-muted mb-0">Susur sungai dengan ban & pelampung, ditemani pemandu.</p>
          </div>
          <div class="attraction-item bg-white rounded-4 p-3 shadow-sm">
          <img src="{{ asset('assets/img/parkir.jpg') }}" alt="Halaman parkir" class="rounded-3 mb-3">
            <h6>Area parkir</h6>
            <p class="small text-muted mb-0">Area parkir di sepanjang sungai yang cukup luas.</p>
          </div>
          <div class="attraction-item bg-white rounded-4 p-3 shadow-sm">
